...
- [x] 2.1 `npm run deploy` exits 0 with `deploy-smoke: PASS`
- [x] 2.2 `npm run db:parity` still exits 0

#### Manual

- [x] 2.3 Deployed: deleting the last set of a both-records exercise shows the sentence once
- [x] 2.4 Deployed: a set holding both records with other sets left still shows two lines
- [x] 2.5 The `edit` dialog is unchanged
